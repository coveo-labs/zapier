...
const outputFields = () => {
  ...
  const output = [
    ...
    { key: 'isRecommendation', label: 'Is this result a recommendation from Machine Learning?' },
    { key: 'isTopResult', label: 'Is this result a configured Top Result?' },
    ...
    { key: 'score', label: 'Score returned by the search for this document' },
